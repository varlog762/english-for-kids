...
export class WordCard extends Category {
    ...
    */
    ...
    get clickedOnTrainMode() {
        const objFromLocalStorafe = JSON.parse(localStorage.getItem(this.word)) ?? false;

        return objFromLocalStorafe ? objFromLocalStorafe.trained : 0;
    }
    ...
    get correctAnswersNum() {
        ...
        return objFromLocalStorafe ? objFromLocalStorafe.correct : 0;
    }
    ...
    get incorrectAnswersNum() {
        ...
        return objFromLocalStorafe ? objFromLocalStorafe.incorrect : 0;
    }
    ...
    */
    ...
    createCardHTML() {
        ...
        const frontSide = createAndInsertElement('div', wordCard, 'word-card-front-side'),
            backSide = createAndInsertElement('div', wordCard, 'word-card-back-side'),
            wordCardFrontFigure = createAndInsertElement('figure', frontSide, 'card-figure'),
            rotateButton = createAndInsertElement('button', frontSide, 'card-rotate-btn'),
            wordCardBackFigure = createAndInsertElement('figure', backSide, 'card-figure');


        const wordCardFrontImg = createAndInsertElement('img', wordCardFrontFigure, 'card-img'),
            wordCardBackImg = createAndInsertElement('img', wordCardBackFigure, 'card-img');
        ...
        const cardTitle = createAndInsertElement('figcaption', wordCardFrontFigure, 'card-title'),
            cardTranslation = createAndInsertElement('figcaption', wordCardBackFigure, 'card-title');
